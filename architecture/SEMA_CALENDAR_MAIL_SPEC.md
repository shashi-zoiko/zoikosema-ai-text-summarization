# ZOIKO SEMA | Governed Agentic Communications — Sema Calendar & Mail

## Engineering Specification — Version 1.1 (Consolidated Build Specification)
...
| Date | 8 July 2026 |
| Class | Class 3 (Technical Specification), inherits from `architecture/SPEC.md` (Class 2 Master Platform Architecture) |
| Ingested into repo | 10 July 2026, on branch `feature/sema-calendar-mail` |

> **Ingestion note:** this file is a verbatim transcription of the specification document supplied by the Founder/CTO on 2026-07-10. The source document was truncated at Appendix D, item 15 ("Hosted email framed as inevitab…") when it was pasted into chat. Everything above that point is reproduced as received. If the remaining Appendix D rows or any section beyond it matter for a given phase of work, get the missing tail from the document owner before treating this file as complete for that phase.
>
> For how this spec maps onto the actual Zoiko Meet codebase (what's reusable, what's net-new, and the Phase 1 build plan), see [`SEMA_CALENDAR_MAIL_CONTEXT.md`](./SEMA_CALENDAR_MAIL_CONTEXT.md). That is the file to read before writing code; this file is the reference of record for what was approved.
...
**Architecture Rule:** Calendar and Mail must not create a second identity plane, a second policy engine, a second audit system, or a second AI permission model. Duplication is an architectural defect.
...
| 15 | Hosted email framed as inevitab… | **[TRUNCATED IN SOURCE — get remainder from document owner before treating Appendix D as complete.]** |
